...
import id.go.bpddiy.social.dto.AuthRequest;
import id.go.bpddiy.social.dto.AuthResponse;
import id.go.bpddiy.social.dto.UserRegistrationRequest;
import id.go.bpddiy.social.model.User;
import id.go.bpddiy.social.repository.UserRepository;
import id.go.bpddiy.social.security.JwtTokenProvider;
...
public class AuthService {
    ...
    public AuthResponse login(AuthRequest request) {
        ...
        User user = userRepository.findByUsernameOrEmail(
                request.getUsernameOrEmail(),
                request.getUsernameOrEmail()).orElseThrow(() -> new RuntimeException("User not found"));
